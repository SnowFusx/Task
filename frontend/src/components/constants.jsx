...
export const NuevoProyectoIcon = () => {
	return (
		<svg
			fill='currentColor'
			viewBox='0 0 16 16'
...
export const NuevoColaboradorIcon = () => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			fill='none'
...
export const NuevoColaboradorXSIcon = () => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			fill='none'
...
export const EliminarColaboradorIcon = () => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			fill='none'
